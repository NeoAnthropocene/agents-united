...
description: Workflow for generating creative technical solutions, evaluating
  design options, and applying SCAMPER/Lateral Thinking frameworks. Use when
  executing structured option generation & brainstorming workflows, phase
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check validates brainstorming document schema |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run test --if-present` | Validation test confirms presence of top candidate trade-off analyses |
