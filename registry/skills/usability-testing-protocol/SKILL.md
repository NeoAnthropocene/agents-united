...
description: Production-grade Usability Testing Protocol playbook for design operations, UX systems, and growth strategy.
metadata:
...
## Overview & Purpose
The Usability Testing Protocol skill provides a deterministic framework for executing usability testing protocol processes in modern software products.
...
### Execution Triggers
- Direct request to execute Usability Testing Protocol tasks.
- Auditing existing product assets or workflows.
- Standardizing usability-testing-protocol procedures across team projects.
...
|---|---|---|
| Specification Document | `docs/usability-testing-protocol/spec.md` | Full specification and guidelines document |
| Component / Asset Files | `src/usability-testing-protocol/*` | Implemented design tokens, components, or campaign assets |
| Audit Report | `reports/usability-testing-protocol/summary.json` | Health check and audit metric results |
...
1. Author primary specification document at `docs/usability-testing-protocol/spec.md`.
...
1. Generate execution summary report at `reports/usability-testing-protocol/summary.md`.
2. Clean up temporary build artifacts and scratch files.
3. Commit generated files to git repository.
   ```bash
   git add docs/usability-testing-protocol/ reports/usability-testing-protocol/
   git commit -m "feat(usability-testing-protocol): implement Usability Testing Protocol playbook artifacts"
   ```
4. Publish documentation for team review.

## Code & Configuration Exemplars

### Exemplar 1: Usability Testing Protocol Configuration Specification
```yaml
version: "2.0.0"
metadata:
  skill: "usability-testing-protocol"
  author: "agents-united"
rules:
  strictValidation: true
  reporting:
    format: "json"
    output: "reports/usability-testing-protocol/summary.json"
```

### Exemplar 2: Usability Testing Protocol Helper Module
```typescript
export function runUsabilityTestingProtocol(scope: string): boolean {
  console.log('Running Usability Testing Protocol on:', scope);
  return true;
}
```
...
### Scenario A: Validation Failure in Usability Testing Protocol
1. **Diagnosis**: Specification or code asset fails validation rules in usability-testing-protocol.
2. **Recovery Protocol**:
...
### Scenario B: Missing Resource for Usability Testing Protocol
