---
name: workflow-design-ops-plan-sprint
description: Operational workflow for scoping design tasks, estimating design
  effort, allocating designer capacity, and planning design sprints. Use when
  executing design sprint & capacity planning workflows, phase transitions, and
  verification gates.
metadata:
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check verifies sprint plan document syntax |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | Project build passes cleanly during sprint planning |
