---
name: workflow-api-contract-design
description: Workflow for designing, validating, and versioning REST OpenAPI
  3.1, GraphQL, and gRPC protobuf schema contracts with zero breaking changes.
  Use when executing api contract & schema design workflows, phase transitions,
