---
name: workflow-ml-eval
description: Rigorous model evaluation, synthetic benchmark testing,
  faithfulness scoring, and Hugging Face scorecard generation. Use when
  executing ml model evaluation & benchmarking workflow workflows, phase
...
|---|---|---|---|
| Phase 1 -> Phase 2 | Datasets validated | `npx agents-united doctor` | Evaluation harness initialized |
| Phase 2 -> Phase 3 | Scoring complete | `npm run test --if-present` | Benchmark outputs parsed into structured metrics |
| Phase 3 -> Completion | Metrics meet quality bar | `npx agents-united doctor` | Scorecard published and verified |
