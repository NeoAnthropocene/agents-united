---
name: workflow-prototyping-testing-prototype-plan
description: Workflow for planning interactive prototype scope, user flow
  branching, fidelity requirements, and data mocking strategies. Use when
  executing interactive prototype architecture plan workflows, phase
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check validates prototype plan document format |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run typecheck --if-present` | Mock data JSON schemas validate cleanly against TypeScript types |
