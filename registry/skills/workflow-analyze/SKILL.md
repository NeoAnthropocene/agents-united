...
description: Workflow for executing static code analysis, vulnerability
  scanning, security audits, and code health assessments. Use when executing
  codebase security & static analysis workflows, phase transitions, and
  verification gates.
metadata:
...
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run typecheck --if-present` | Static type checking passes cleanly |
