---
name: workflow-seo-content-pipeline
description: End-to-end workflow for programmatic keyword research, schema
  markup architecture, automated SEO content drafting, and crawl validation. Use
  when executing programmatic seo & content generation pipeline workflows, phase
...
| Phase 2 -> Phase 3 | Execution steps complete | `npm run test --if-present` | SEO test suite validates Schema.org JSON-LD syntax and internal link graph integrity |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | Static site generator builds programmatic pages and XML sitemap without errors |
