---
name: workflow-design-orchestrate
description: Master orchestration workflow coordinating UI designers, UX
  strategists, interaction designers, and design system leads on end-to-end
  design initiatives. Use when executing multi-agent design orchestration
...
| Phase 2 -> Phase 3 | Execution steps complete | `npm run test --if-present` | Orchestration test suite confirms all subagent deliverables meet quality gates |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | Master design documentation builds cleanly |
