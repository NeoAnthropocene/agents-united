---
name: workflow-marketing-campaign-builder
description: End-to-end workflow for building integrated marketing campaigns
  across email, social media, paid ads, and landing pages. Use when executing
  multi-channel marketing campaign construction workflows, phase transitions,
...
| Phase 2 -> Phase 3 | Execution steps complete | `npm run test --if-present` | UTM link validator verifies 100% of campaign links contain correct tracking parameters |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | Email HTML templates and campaign assets build without errors |
