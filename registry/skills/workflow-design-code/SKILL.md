---
name: workflow-design-code
description: Workflow for designing clean code interfaces, TypeScript
  types/interfaces, OpenAPI/REST schemas, and module contracts. Use when
  executing api & interface specification design workflows, phase transitions,
...
| Phase 2 -> Phase 3 | Execution steps complete | `npm run typecheck --if-present` | TypeScript compiler validates all new type interfaces without errors |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run test --if-present` | Schema validation unit tests pass cleanly against sample data |
