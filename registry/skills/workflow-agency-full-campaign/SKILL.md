...
description: End-to-end multi-agent cross-functional agency workflow spanning
  strategy, copywriting, UI/UX design, frontend development, and compliance
  audit. Use when executing digital agency full-funnel campaign orchestration
  workflows, phase transitions, and verification gates.
metadata:
...
|---|---|---|---|
| Phase 1 -> Phase 2 | Strategy formulated & budget approved | `npx agents-united doctor` | Doctor health check succeeds with 0 errors |
| Phase 2 -> Phase 3 | Copy & visual prototypes completed | `npm run typecheck --if-present` | Component layouts and tokens compile cleanly |
| Phase 3 -> Completion | End-to-end integration verified | `npm run test --if-present` | 100% pass across E2E test suites and accessibility gates |
