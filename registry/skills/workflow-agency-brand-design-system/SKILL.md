...
description: Tokenized design system architecture, Figma token sync, Tailwind
  color palettes, and Storybook interactive component playground setup. Use when
  executing agency brand design system & component library workflows, phase
...
|---|---|---|---|
| Phase 1 -> Phase 2 | Tokens declared | `npx agents-united doctor` | Doctor health check succeeds with 0 errors |
| Phase 2 -> Phase 3 | Components implemented | `npm run typecheck --if-present` | TypeScript component interfaces compile cleanly |
| Phase 3 -> Completion | Visual contracts verified | `npm run build --if-present` | Storybook / component assets build without errors |
