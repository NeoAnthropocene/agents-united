---
name: workflow-marketing-audit
description: Comprehensive workflow for auditing acquisition channels,
  conversion funnels, landing page performance, and analytics tracking. Use when
  executing growth & marketing funnel audit workflows, phase transitions, and
  verification gates.
metadata:
...
| Phase 2 -> Phase 3 | Execution steps complete | `npm run test --if-present` | Funnel analytics script verifies data consistency across conversion stages |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | Build pipeline validates audit report compilation |
