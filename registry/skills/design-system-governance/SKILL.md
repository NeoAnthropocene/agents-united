...
description: Production-grade Design System Governance playbook for design operations, UX systems, and growth strategy.
metadata:
...
## Overview & Purpose
The Design System Governance skill provides a deterministic framework for executing design system governance processes in modern software products.
...
### Execution Triggers
- Direct request to execute Design System Governance tasks.
- Auditing existing product assets or workflows.
- Standardizing design-system-governance procedures across team projects.
...
|---|---|---|
| Specification Document | `docs/design-system-governance/spec.md` | Full specification and guidelines document |
| Component / Asset Files | `src/design-system-governance/*` | Implemented design tokens, components, or campaign assets |
| Audit Report | `reports/design-system-governance/summary.json` | Health check and audit metric results |
...
1. Author primary specification document at `docs/design-system-governance/spec.md`.
...
1. Generate execution summary report at `reports/design-system-governance/summary.md`.
2. Clean up temporary build artifacts and scratch files.
3. Commit generated files to git repository.
   ```bash
   git add docs/design-system-governance/ reports/design-system-governance/
   git commit -m "feat(design-system-governance): implement Design System Governance playbook artifacts"
   ```
4. Publish documentation for team review.

## Code & Configuration Exemplars

### Exemplar 1: Design System Governance Configuration Specification
```yaml
version: "2.0.0"
metadata:
...
rules:
  ...
  reporting:
    format: "json"
    output: "reports/design-system-governance/summary.json"
```

### Exemplar 2: Design System Governance Helper Module
```typescript
export function runDesignSystemGovernance(scope: string): boolean {
  console.log('Running Design System Governance on:', scope);
  return true;
}
```
...
### Scenario A: Validation Failure in Design System Governance
1. **Diagnosis**: Specification or code asset fails validation rules in design-system-governance.
2. **Recovery Protocol**:
...
### Scenario B: Missing Resource for Design System Governance
