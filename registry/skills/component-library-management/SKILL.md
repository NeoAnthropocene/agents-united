...
description: Production-grade Component Library Management playbook for design operations, UX systems, and growth strategy.
metadata:
...
## Overview & Purpose
The Component Library Management skill provides a deterministic framework for executing component library management processes in modern software products.
...
### Execution Triggers
- Direct request to execute Component Library Management tasks.
- Auditing existing product assets or workflows.
- Standardizing component-library-management procedures across team projects.
...
|---|---|---|
| Specification Document | `docs/component-library-management/spec.md` | Full specification and guidelines document |
| Component / Asset Files | `src/component-library-management/*` | Implemented design tokens, components, or campaign assets |
| Audit Report | `reports/component-library-management/summary.json` | Health check and audit metric results |
...
1. Author primary specification document at `docs/component-library-management/spec.md`.
...
1. Generate execution summary report at `reports/component-library-management/summary.md`.
2. Clean up temporary build artifacts and scratch files.
3. Commit generated files to git repository.
   ```bash
   git add docs/component-library-management/ reports/component-library-management/
   git commit -m "feat(component-library-management): implement Component Library Management playbook artifacts"
   ```
4. Publish documentation for team review.

## Code & Configuration Exemplars

### Exemplar 1: Component Library Management Configuration Specification
```yaml
version: "2.0.0"
metadata:
...
rules:
  ...
  reporting:
    format: "json"
    output: "reports/component-library-management/summary.json"
```

### Exemplar 2: Component Library Management Helper Module
```typescript
export function runComponentLibraryManagement(scope: string): boolean {
  console.log('Running Component Library Management on:', scope);
  return true;
}
```
...
### Scenario A: Validation Failure in Component Library Management
1. **Diagnosis**: Specification or code asset fails validation rules in component-library-management.
2. **Recovery Protocol**:
...
### Scenario B: Missing Resource for Component Library Management
