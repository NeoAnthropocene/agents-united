---
name: workflow-grill
description: Interactive orchestration workflow for Socratic requirements
  grilling, ubiquitous language definition in CONTEXT.md, and ADR creation. Use
  when executing socratic alignment & domain grilling workflows, phase
