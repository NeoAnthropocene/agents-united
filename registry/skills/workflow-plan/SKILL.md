---
name: workflow-plan
description: Comprehensive workflow for creating architectural plans, system
  design documents, module specifications, and implementation roadmaps. Use when
  executing architecture & technical planning workflows, phase transitions, and
  verification gates.
metadata:
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | System architecture plan schema and references pass health verification |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run typecheck --if-present` | Proposed data model types compile cleanly without type syntax errors |
