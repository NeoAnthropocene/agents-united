---
name: workflow-design-systems-audit-system
description: Workflow for auditing codebase UI components against design system
  standards, detecting hardcoded styles, and cataloging component drift. Use
  when executing design system & component drift audit workflows, phase
...
| Phase 2 -> Phase 3 | Execution steps complete | `npm run test --if-present` | Drift audit script completes scan across 100% of codebase UI files |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run typecheck --if-present` | Static type checking passes cleanly post-scan |
