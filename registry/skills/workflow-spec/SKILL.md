---
name: workflow-spec
description: Procedural workflow for generating PRD specs from notes or grilling
  results and breaking them down into actionable backlog tickets. Use when
  executing technical specification & backlog breakdown workflows, phase
