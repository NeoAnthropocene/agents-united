---
name: workflow-ux-strategy-strategize
description: Strategic workflow for synthesizing research, business goals, and
  technical feasibility into an actionable multi-horizon UX vision. Use when
  executing comprehensive ux strategy roadmap workflows, phase transitions, and
  verification gates.
metadata:
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check validates UX strategy document structure |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | Build pipeline confirms documentation artifacts compile cleanly |
