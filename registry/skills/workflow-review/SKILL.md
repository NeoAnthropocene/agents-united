...
description: Structured review workflow for inspecting code diffs, checking
  architectural pattern compliance, security flaws, and performance
  anti-patterns. Use when executing automated & peer code review workflows,
...
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run lint --if-present && npm run typecheck --if-present` | All automated lints and type checks pass cleanly on PR branch |
