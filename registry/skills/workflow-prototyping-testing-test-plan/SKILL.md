---
name: workflow-prototyping-testing-test-plan
description: Workflow for authoring user test plans, recruiting criteria, task
  scenarios, post-test questionnaires, and moderation scripts. Use when
  executing user testing script & methodology plan workflows, phase transitions,
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check confirms test plan document compliance |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run test --if-present` | Validation test confirms task script timing parameters |
