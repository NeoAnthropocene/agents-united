---
name: workflow-business-panel
description: Panel workflow assembling business strategists, product managers,
  and financial analysts to evaluate product monetization, pricing, and business
  viability. Use when executing expert business evaluation panel workflows,
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check validates business panel report format |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run test --if-present` | Validation test suite confirms presence of financial metrics |
