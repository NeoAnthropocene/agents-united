---
name: workflow-seo-audit-pipeline
description: Comprehensive SEO audit, schema validation, sitemap generation, and
  programmatic page deployment. Use when executing technical seo audit &
  programmatic deployment workflow workflows, phase transitions, and
  verification gates.
metadata:
...
|---|---|---|---|
| Phase 1 -> Phase 2 | Crawl checks pass | `npx agents-united doctor` | 0 robots.txt or canonical errors |
| Phase 2 -> Phase 3 | Schema injected | `npm run test --if-present` | JSON-LD schema syntax validates cleanly |
| Phase 3 -> Completion | Sitemap verified | `npx agents-united doctor` | Sitemaps compiled with valid XML |
