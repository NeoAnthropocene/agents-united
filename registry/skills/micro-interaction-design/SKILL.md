...
description: Production-grade Micro Interaction Design playbook for design operations, UX systems, and growth strategy.
metadata:
...
## Overview & Purpose
The Micro Interaction Design skill provides a deterministic framework for executing micro interaction design processes in modern software products.
...
### Execution Triggers
- Direct request to execute Micro Interaction Design tasks.
- Auditing existing product assets or workflows.
- Standardizing micro-interaction-design procedures across team projects.
...
|---|---|---|
| Specification Document | `docs/micro-interaction-design/spec.md` | Full specification and guidelines document |
| Component / Asset Files | `src/micro-interaction-design/*` | Implemented design tokens, components, or campaign assets |
| Audit Report | `reports/micro-interaction-design/summary.json` | Health check and audit metric results |
...
1. Author primary specification document at `docs/micro-interaction-design/spec.md`.
...
1. Generate execution summary report at `reports/micro-interaction-design/summary.md`.
2. Clean up temporary build artifacts and scratch files.
3. Commit generated files to git repository.
   ```bash
   git add docs/micro-interaction-design/ reports/micro-interaction-design/
   git commit -m "feat(micro-interaction-design): implement Micro Interaction Design playbook artifacts"
   ```
4. Publish documentation for team review.

## Code & Configuration Exemplars

### Exemplar 1: Micro Interaction Design Configuration Specification
```yaml
version: "2.0.0"
metadata:
  skill: "micro-interaction-design"
  author: "agents-united"
rules:
  strictValidation: true
  reporting:
    format: "json"
    output: "reports/micro-interaction-design/summary.json"
```

### Exemplar 2: Micro Interaction Design Helper Module
```typescript
export function runMicroInteractionDesign(scope: string): boolean {
  console.log('Running Micro Interaction Design on:', scope);
  return true;
}
```
...
### Scenario A: Validation Failure in Micro Interaction Design
1. **Diagnosis**: Specification or code asset fails validation rules in micro-interaction-design.
2. **Recovery Protocol**:
...
### Scenario B: Missing Resource for Micro Interaction Design
