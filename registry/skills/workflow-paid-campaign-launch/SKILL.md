---
name: workflow-paid-campaign-launch
description: PPC campaign setup, ad copy testing, conversion tracking pixel
  verification, and launch budgeting. Use when executing paid campaign
  architecture & launch workflow workflows, phase transitions, and verification
  gates.
metadata:
...
|---|---|---|---|
| Phase 1 -> Phase 2 | Tracking active | `npx agents-united doctor` | Conversion pixels and test events verified |
| Phase 2 -> Phase 3 | Assets assembled | `npm run test --if-present` | All creative dimensions and copy lengths valid |
| Phase 3 -> Completion | Campaigns live | `npx agents-united doctor` | Impressions recording with verified attribution |
