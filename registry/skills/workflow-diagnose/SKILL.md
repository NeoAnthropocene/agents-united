...
description: Procedural workflow for isolating software bugs, gathering
  empirical evidence, and formulating root-cause remediation plans. Use when
  executing evidence-driven bug diagnosis workflows, phase transitions, and
  verification gates.
metadata:
