---
name: workflow-ui-design-responsive-audit
description: Comprehensive audit workflow for verifying UI layout reflow, touch
  targets, and typography readability across mobile, tablet, and desktop
  viewports. Use when executing responsive breakpoint ui audit workflows, phase
...
| Phase 2 -> Phase 3 | Execution steps complete | `npm run test --if-present` | Responsive audit suite confirms 0 horizontal scroll overflow on mobile |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | CSS media queries and breakpoint utility classes compile cleanly |
