---
name: workflow-ui-design-design-screen
description: Workflow for designing high-fidelity screen UI layouts, typography
  hierarchy, visual assets, and component assembly. Use when executing screen
  visual design & layout workflows, phase transitions, and verification gates.
metadata:
...
| Phase 2 -> Phase 3 | Execution steps complete | `npm run test --if-present` | Visual layout test suite confirms 0 grid alignment violations |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | Design assets compile cleanly into build pipeline |
