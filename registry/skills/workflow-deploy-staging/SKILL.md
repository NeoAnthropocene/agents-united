---
name: workflow-deploy-staging
description: Workflow for automating container builds, staging preview
  deployments, environment sanity checks, and deployment verification gates. Use
  when executing staging preview & deployment automation workflows, phase
