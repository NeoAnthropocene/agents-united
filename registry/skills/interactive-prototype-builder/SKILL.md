...
description: Production-grade Interactive Prototype Builder playbook for design operations, UX systems, and growth strategy.
metadata:
...
## Overview & Purpose
The Interactive Prototype Builder skill provides a deterministic framework for executing interactive prototype builder processes in modern software products.
...
### Execution Triggers
- Direct request to execute Interactive Prototype Builder tasks.
- Auditing existing product assets or workflows.
- Standardizing interactive-prototype-builder procedures across team projects.
...
| Component / Asset Files | `src/interactive-prototype-builder/*` | Implemented design tokens, components, or campaign assets |
| Audit Report | `reports/interactive-prototype-builder/summary.json` | Health check and audit metric results |
...
### Scenario A: Validation Failure in Interactive Prototype Builder
1. **Diagnosis**: Specification or code asset fails validation rules in interactive-prototype-builder.
2. **Recovery Protocol**:
...
### Scenario B: Missing Resource for Interactive Prototype Builder
