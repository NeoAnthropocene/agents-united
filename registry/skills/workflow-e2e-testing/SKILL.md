---
name: workflow-e2e-testing
description: Workflow for authoring and running Playwright browser test specs,
  capturing failure traces/videos, and validating critical user journeys. Use
  when executing end-to-end browser test automation workflows, phase
