---
name: workflow-marketing-panel
description: Panel workflow assembling growth, content, copy, and conversion
  specialists to evaluate marketing positioning and campaigns. Use when
  executing marketing & messaging review panel workflows, phase transitions, and
  verification gates.
metadata:
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check confirms marketing panel report format |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run test --if-present` | Validation tests pass for copy audit report artifacts |
