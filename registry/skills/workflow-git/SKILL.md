---
name: workflow-git
description: Workflow for managing git feature branches, atomic commit
  formatting, rebase workflow, PR preparation, and merge readiness. Use when
  executing git version control & branch strategy workflows, phase transitions,
