---
name: workflow-marketing-content-pipeline
description: Workflow for keyword research, content drafting, SEO optimization,
  editorial review, and content publishing. Use when executing content engine &
  seo pipeline workflows, phase transitions, and verification gates.
metadata:
...
| Phase 2 -> Phase 3 | Execution steps complete | `npm run test --if-present` | SEO content test suite validates Schema.org JSON-LD syntax |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | CMS static site generator builds page cleanly |
