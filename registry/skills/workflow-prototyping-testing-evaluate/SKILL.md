---
name: workflow-prototyping-testing-evaluate
description: Workflow for analyzing user test recordings, quantifying task
  completion rates, identifying UX friction, and synthesizing test findings. Use
  when executing prototype usability evaluation & analytics workflows, phase
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check confirms evaluation report schema validity |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run test --if-present` | Usability metric calculation script validates data totals |
