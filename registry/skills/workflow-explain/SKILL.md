...
description: Workflow for explaining complex codebase architectures, technical
  concepts, design patterns, and code implementations clearly. Use when
  executing architectural explanation & technical walkthrough workflows, phase
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check confirms explanation document structure |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run typecheck --if-present` | Code snippets inside explanation compile cleanly |
