...
description: Workflow for conducting literature reviews, technical feasibility
  research, codebase analysis, and domain background investigations. Use when
  executing deep technical & domain research workflows, phase transitions, and
  verification gates.
metadata:
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Doctor health check confirms research report document structure |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run test --if-present` | Report validation test suite confirms citation references |
