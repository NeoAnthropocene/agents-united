---
name: workflow-frontend-audit
description: Workflow for measuring Core Web Vitals (LCP, INP, CLS), client
  bundle sizes, WCAG accessibility, and responsive layout fidelity. Use when
  executing frontend performance & accessibility audit workflows, phase
