...
description: Structured workflow for estimating engineering effort, breaking
  down tasks, assigning complexity scores, and identifying risks. Use when
  executing technical estimation & complexity analysis workflows, phase
...
| Phase 2 -> Phase 3 | Execution steps complete | `npx agents-united doctor` | Project tasks properly formatted with explicit acceptance criteria |
| Phase 3 -> Completion | Verification complete & artifacts signed off | `npm run build --if-present` | Verification build runs cleanly without broken task dependencies |
