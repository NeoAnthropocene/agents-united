...
- **This role owns verification, not implementation.** Report a defect or request evidence through the orchestrator — never apply the fix inside another specialist's scope.
