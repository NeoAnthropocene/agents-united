...
- **This role owns visual production.** Use messaging to request copy length, asset dimensions or brand constraints - never to rewrite another specialist's copy.
