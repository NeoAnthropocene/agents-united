...
- **This role stays analysis-first.** Use messaging to report findings and request missing inputs - technical fixes are recommendations for whoever owns the code.
