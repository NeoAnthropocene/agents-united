...
- **This role owns campaign orchestration.** Sequence hand-offs (copy, creative, tracking) through the orchestrator that spawned you — the campaign brief stays the single source of truth.
