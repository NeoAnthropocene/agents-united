...
| [019](./019-orchestrator-pm-and-tier1-planning-consultation.md) | Orchestrator-as-PM, Tier-1 Planning Consultation & Projection-Residue Purge | Catalog / Runtime Integration | **READY — approved 2026-09-24** (per-file-group `.cline/**` sign-off confirmed) **Reframe (ADR 0021)**: the residue purge doubles as step 1 of Semantic Core extraction — stripping host nouns from semantics is exactly purifying the core (see Plan 021) | 017, 018 (soft) |
...
| [022](./022-subagent-comms-and-hardening.md) | Subagent Comms & Hardening (proposal C1–C7 / H1–H7 + canonical-store-optional installs) | Core / Runtime Integration / Catalog | **AUTHORIZED — 2026-09-25** (Gate 7 field report `2026-09-25-subagent-communication-and-hardening.md`; sidecar-integrity fix landed as pre-work (ADR 0017 amendment); implements ADR 0022 store-less installs; acceptance gates mirror the proposal's §5) | 019, 021, ADR 0022 |
