...
| [019](./019-orchestrator-pm-and-tier1-planning-consultation.md) | Orchestrator-as-PM, Tier-1 Planning Consultation & Projection-Residue Purge | Catalog / Runtime Integration | **READY — approved 2026-09-24** (per-file-group `.cline/**` sign-off confirmed) | 017, 018 (soft) |
| [020](./020-host-slash-commands-rulebook.md) | Host Slash-Commands Rulebook & Command-Aware Projection | Documentation / Catalog / Core | **READY — approved 2026-09-24** | 017 |
